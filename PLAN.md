...
- **Week 1**: toolchain finish (wasm-pack, wrangler) → Rust crate SSE framing + ring buffer, native tests only, no WASM yet → wasm-pack build + smoke test through a bare Worker.
